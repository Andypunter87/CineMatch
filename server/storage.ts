...
export class MemStorage implements IStorage {
  ...
  async getRecommendations(preferences: RecommendationRequest): Promise<Film[]> {
    // Create a score for each film based on how well it matches the user preferences
    const scoredFilms = this.films.map(film => {
      ...
      if (preferences.timeOfDay === "weekday" && 
      ...
      } else if (preferences.timeOfDay === "weekend" && 
      ...
      } else if (preferences.timeOfDay === "late" && 
